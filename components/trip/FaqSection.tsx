...
const defaultFaqs: FaqItem[] = [
  {
    ...
    answer: [
      ...
      "ניתן להגיע לתחנת Tower Hill בקלות רבה באמצעות הרכבת התחתית (Tube), בקווים: Circle (הצהוב)",
      "או District (הירוק)",
      "תבחרו, שניהם מגיעים :)",
    ],
  },
  {
    question: "אנחנו מאוד רוצים לטייל בחורף, איך מזג האוויר שם בעונה זו?",
    answer: [
      "למרות שמזג האוויר באנגליה קריר, הגשמים לרוב קלים קצרים ועדינים, מעין ריסוס כזה. שלג פחות שכיח.",
      "מומלץ בחורף ללבוש בגדים טרמיים.",
    ],
  },
  {
  ...
  {
    question: "האם ניתן להצטרף רק ליום אחד?",
    answer: "זהו טיול של יומיים עם לינה, לא ניתן להצטרף רק ליום אחד.",
  },
  {
    question: "האם הטיול כולל ארוחות?",
    answer: "הטיול כולל ארוחת בוקר במלון בלבד. שאר הארוחות הן באחריות המטיילים.",
  },
  {
