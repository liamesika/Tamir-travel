        ...
        >
          <div className="bg-gradient-to-r from-heritage-50 to-heritage-100 border border-heritage-200 rounded-lg p-3 sm:p-4">
            ...
            <p className="text-sage-700 leading-relaxed text-xs sm:text-sm">
              בחודשי החורף מומלץ להצטייד בגטקס, זה ירגיש לכם בדיוק כמו מזג האוויר בארץ.
              מומלץ להגיע עם שכבות ביגוד (מזג האוויר באנגליה משתנה!), ומזוודה קטנה או תיק ללינה. אל תשכחו מקום לקניות מהאאוטלט! 🛍️
            </p>
          </div>
        </div>
      </div>
